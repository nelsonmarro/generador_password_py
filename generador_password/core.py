...
def generate_password(length: int, use_upper: bool, use_lower: bool, use_numbers: bool, use_symbols: bool) -> str:
    ...
    if length < len(password_chars):
        raise ValueError(f"La longitud mínima para estos criterios es {len(password_chars)}.")
